...
public class MainZadanieJeden extends Application {
    ...
    static final RunLengthEncoder runLengthEncoder = new RunLengthEncoder();

    public MainZadanieJeden() {
    }
        ...
        try {
            ...
            enterButton.setOnAction(event -> {
                if (codingRadioButton.isSelected()) {
                    outputData.clear();
                    outputData.appendText(runLengthEncoder.encoder("xxxxx"));
                }
                else if (decodingRadioButton.isSelected()) {
                    outputData.clear();
                    outputData.appendText(runLengthEncoder.decode("yyyyy"));
                } else {
                    outputData.clear();
